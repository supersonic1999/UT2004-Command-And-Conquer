class RemoteC4Proj extends ONSGrenadeProjectile;
...
{
    if (!bPendingDelete && Base == None && Other != IgnoreActor && xPawn(Other) == none
    && (!Other.bWorldGeometry && Other.Class != Class && (Other != Instigator || bCanHitOwner)))
