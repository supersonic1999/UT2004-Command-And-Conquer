...
{
    myUpdateHit(HitActor, HitLocation, HitNormal);
}

simulated function myUpdateHit(Actor HitActor, vector HitLocation, vector HitNormal)
{
    SpawnHitCount++;
	mHitLocation = HitLocation;
	mHitActor = HitActor;
	mHitNormal = HitNormal;
	Instigator.Weapon.IncrementFlashCount(0);
}
