class PersonalIonCannonFire extends InstantFire;
...
defaultproperties
{
     ...
     DamageType=Class'commandandconquer.DamTypeIonCannon'
     DamageMin=80
     DamageMax=80
     ...
     FireRate=2.000000
     AmmoClass=Class'commandandconquer.PersonalIonCannonAmmo'
     AmmoPerFire=1
