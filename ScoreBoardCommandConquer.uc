class ScoreBoardCommandConquer extends ScoreBoardTeamDeathMatch;
...
//		if ( i != OwnerOffset )
//		{
//			Canvas.SetPos(ScoreXPos, (PlayerBoxSizeY + BoxSpaceY)*i + BoxTextOffsetY + 5);
//			Canvas.DrawText(CommandController(PRIArray[i].Owner).Money,true);
//		}
...
defaultproperties
{
     TeamBoxMaterial(1)=Texture'InterfaceContent.Menu.ScoreBoxA'
     TeamColors(1)=(B=0,G=255,R=255)
}
