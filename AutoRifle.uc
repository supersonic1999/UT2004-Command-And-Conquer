...
defaultproperties
{
     FireModeClass(0)=Class'commandandconquer.AutoRifleFire'
     FireModeClass(1)=Class'commandandconquer.AutoRifleFire'
     PutDownAnim="PutDown"
     ...
     BobDamping=1.700000
     AttachmentClass=Class'commandandconquer.AutoRifleAttachment'
     IconMaterial=Texture'HUDContent.Generic.HUD'
     IconCoords=(X1=245,Y1=39,X2=329,Y2=79)
     ItemName="Automatic Rifle"
     LightType=LT_Pulse
