...
defaultproperties
{
     FireModeClass(0)=Class'commandandconquer.ShotgunFire'
     FireModeClass(1)=Class'commandandconquer.ShotgunFire'
     SelectAnim="Pickup"
     PutDownAnim="PutDown"
     ...
     BobDamping=1.400000
     AttachmentClass=Class'commandandconquer.ShotgunAttachment'
