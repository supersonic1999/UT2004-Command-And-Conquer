class PersonalIonCannon extends Weapon
    config(user);
...
defaultproperties
{
     ...
     FireModeClass(0)=Class'commandandconquer.PersonalIonCannonFire'
     FireModeClass(1)=Class'commandandconquer.PersonalIonCannonFire'
     SelectAnim="Pickup"
     PutDownAnim="PutDown"
