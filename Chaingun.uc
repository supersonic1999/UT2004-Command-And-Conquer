...
simulated function bool StartFire(int mode)
{
	...
	if ( !ChaingunFire(FireMode[0]).IsIdle() || !ChaingunFire(FireMode[1]).IsIdle() )
		return false;
...
defaultproperties
{
     ...
     GearRatio=-2.370000
     Blend=1.000000
     FireModeClass(0)=Class'commandandconquer.ChaingunFire'
     FireModeClass(1)=Class'commandandconquer.ChaingunFire'
     PutDownAnim="PutDown"
     ...
     BobDamping=2.250000
     AttachmentClass=Class'commandandconquer.ChainGunAttachment'
